	...
	return {
		...
		paint: function($element, layout) {
			...
			if (selectcustomstyle) {
				...
				basestyle += ' .qv-panel-current-selections .buttons .qv-subtoolbar-button i {  color: ' + layout.prop.selectionbartextcolor + ' !important; } \n';
				basestyle += ' .qv-panel-current-selections .buttons-end .qv-subtoolbar-button i{  color: ' + layout.prop.selectionbartextcolor + ' !important; } \n';
				...
				if (layout.pivotsupport) {
					...
					basestyle += '.qv-object-pivot-table .qv-inner-object table tr:nth-child(1) {background: ' + pivottablebgcolor + ' !important; color: ' + pivottablecolor + ' !important;}';
